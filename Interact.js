...
(function runTests() {
    ...
    test([[5],[[1,1], [0]]         ], [1,2,"foo", {x:5      }], '[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1...');
    test(['!',[[1,1], [0,1]]       ], [1,2,"foo", {x:5      }], '!');
    test([[5],[[1,1], [0,"values"]]], [1,2,"foo", {x:5      }], '[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1,2,"foo",{x:5}],null,[[1...');
    test([[5],[[1,1], [0,"parent"]]], [1,2,"foo", {x:5      }], rootContext);
